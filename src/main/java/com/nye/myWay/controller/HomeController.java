...
public class HomeController {
    ...
    ResponseEntity<Page<BookResponseAdminDTO>> getFilteredBooks(@RequestBody BookPaginationRequestDTO paginationRequest) {
        ...
        try {
            Page<BookResponseAdminDTO> filteredBooks = bookService.getFilteredBook(page, size, direction, orderBy);
